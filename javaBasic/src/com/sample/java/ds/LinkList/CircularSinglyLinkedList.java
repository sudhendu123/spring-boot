...
public class CircularSinglyLinkedList {
	...
	protected CSLLNode start ;
    protected CSLLNode end ;
    public int size ;
    ...
    {
        CSLLNode nptr = new CSLLNode(val,null);    
        nptr.setLink(start);
        if(start == null)
        {            
            start = nptr;
...
class CSLLNode
{
    ...
    /*  Constructor  */
    public CSLLNode(int d,CSLLNode n)
    {
        data = d;
        link = n;
    }    
    /*  Function to set link to next Node  */
    public void setLink(CSLLNode n)
    {
        link = n;
    }    
